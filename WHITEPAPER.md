# Planet CGI — Whitepaper

**Fleet designation:** `planet-cgi` · Part of the Counted fleet.

## Abstract

Compositor: layer stack, blend modes, shader catalog with uniforms pipeline. This repository ships a self-contained, deterministic implementation:
